...
class Author(models.Model):
    ...
    def update_rating(self):
        ...
        """
        u = self.user
        posts_rating1 = Post.rating.get(user=u)
        ...
        print(f"Рейтинг постов = {posts_rating1}")
        """print(f"Рейтинг комментов = {comments_rating}")"""
        self.rating = 3 * posts_rating1 """+ comments_rating"""
        self.save()
        print(f"Рейтинг = 3 * {posts_rating1}  = {self.rating}")
